...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionRadial : MonoBehaviour
    {
        ...
        [SerializeField] private RayIrradiatorBase m_rayIrradiator; 
        ...
        {
            m_rayIrradiator.OnRayHit += HandleDown;
            m_rayIrradiator.OnRayOut += HandleUp;
        }
        ...
        public void Show()
        {
            if (!m_Selection.gameObject.activeInHierarchy)
            {
